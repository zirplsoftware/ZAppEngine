...
using Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.Partners;
...
namespace Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.DataService.Partners
{
	[TestFixture]
    public partial class PartnerReferralCouponRequestStatusTypeDataServiceTests : PartnerReferralCouponRequestStatusTypeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class PartnerReferralCouponRequestStatusTypeDataServiceTestsBase : DictionaryEntityLayerTestFixtureBase<PartnerReferralCouponRequestStatusType, byte, PartnerReferralCouponRequestStatusTypeEnum>
    {
		protected IPartnerReferralCouponRequestStatusTypeDataService DataService {get { return this.DependencyResolver.Resolve<IPartnerReferralCouponRequestStatusTypeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPartnerReferralCouponRequestStatusTypeDataService>() as TSupports;
        }		
