...
{	
	[TestFixture]
    public partial class PartnerReferralPlanDataServiceTests : PartnerReferralPlanDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class PartnerReferralPlanDataServiceTestsBase : EntityLayerTestFixtureBase<PartnerReferralPlan, int, PartnerReferralPlanEntityWrapper, PartnerReferralPlanTestsStrategy>
    {
		protected IPartnerReferralPlanDataService DataService {get { return this.DependencyResolver.Resolve<IPartnerReferralPlanDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPartnerReferralPlanDataService>() as TSupports;
        }		
