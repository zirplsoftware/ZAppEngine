...
{	
	[TestFixture]
    public partial class PartnerReferralCouponRequestDataServiceTests : PartnerReferralCouponRequestDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class PartnerReferralCouponRequestDataServiceTestsBase : EntityLayerTestFixtureBase<PartnerReferralCouponRequest, int, PartnerReferralCouponRequestEntityWrapper, PartnerReferralCouponRequestTestsStrategy>
    {
		protected IPartnerReferralCouponRequestDataService DataService {get { return this.DependencyResolver.Resolve<IPartnerReferralCouponRequestDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPartnerReferralCouponRequestDataService>() as TSupports;
        }		
