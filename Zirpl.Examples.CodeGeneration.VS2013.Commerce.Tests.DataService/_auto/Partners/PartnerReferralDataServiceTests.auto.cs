...
{	
	[TestFixture]
    public partial class PartnerReferralDataServiceTests : PartnerReferralDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class PartnerReferralDataServiceTestsBase : EntityLayerTestFixtureBase<PartnerReferral, int, PartnerReferralEntityWrapper, PartnerReferralTestsStrategy>
    {
		protected IPartnerReferralDataService DataService {get { return this.DependencyResolver.Resolve<IPartnerReferralDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPartnerReferralDataService>() as TSupports;
        }		
