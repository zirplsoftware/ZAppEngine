...
{	
	[TestFixture]
    public partial class PartnerDataServiceTests : PartnerDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class PartnerDataServiceTestsBase : EntityLayerTestFixtureBase<Partner, int, PartnerEntityWrapper, PartnerTestsStrategy>
    {
		protected IPartnerDataService DataService {get { return this.DependencyResolver.Resolve<IPartnerDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPartnerDataService>() as TSupports;
        }		
