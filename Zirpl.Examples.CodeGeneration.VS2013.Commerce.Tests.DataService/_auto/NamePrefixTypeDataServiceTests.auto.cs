...
{
	[TestFixture]
    public partial class NamePrefixTypeDataServiceTests : NamePrefixTypeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class NamePrefixTypeDataServiceTestsBase : DictionaryEntityLayerTestFixtureBase<NamePrefixType, byte, NamePrefixTypeEnum>
    {
		protected INamePrefixTypeDataService DataService {get { return this.DependencyResolver.Resolve<INamePrefixTypeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<INamePrefixTypeDataService>() as TSupports;
        }		
