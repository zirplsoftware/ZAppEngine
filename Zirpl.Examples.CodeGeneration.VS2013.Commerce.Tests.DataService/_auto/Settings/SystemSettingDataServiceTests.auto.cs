...
{	
	[TestFixture]
    public partial class SystemSettingDataServiceTests : SystemSettingDataServiceTestsBase
    {
	}
    ...
    {
		protected ISystemSettingDataService DataService {get { return this.DependencyResolver.Resolve<ISystemSettingDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISystemSettingDataService>() as TSupports;
        }		
