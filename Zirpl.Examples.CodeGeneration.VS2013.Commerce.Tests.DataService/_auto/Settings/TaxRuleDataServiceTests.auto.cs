...
{	
	[TestFixture]
    public partial class TaxRuleDataServiceTests : TaxRuleDataServiceTestsBase
    {
	}
    ...
    {
		protected ITaxRuleDataService DataService {get { return this.DependencyResolver.Resolve<ITaxRuleDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ITaxRuleDataService>() as TSupports;
        }		
