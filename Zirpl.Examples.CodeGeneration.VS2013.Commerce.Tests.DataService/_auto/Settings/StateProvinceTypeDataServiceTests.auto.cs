...
namespace Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.DataService.Settings
{
	[TestFixture]
    public partial class StateProvinceTypeDataServiceTests : StateProvinceTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected IStateProvinceTypeDataService DataService {get { return this.DependencyResolver.Resolve<IStateProvinceTypeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IStateProvinceTypeDataService>() as TSupports;
        }		
