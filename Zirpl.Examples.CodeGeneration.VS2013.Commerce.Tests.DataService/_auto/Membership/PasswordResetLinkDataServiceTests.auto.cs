...
namespace Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.DataService.Membership
{	
	[TestFixture]
    public partial class PasswordResetLinkDataServiceTests : PasswordResetLinkDataServiceTestsBase
    {
	}
    ...
    {
		protected IPasswordResetLinkDataService DataService {get { return this.DependencyResolver.Resolve<IPasswordResetLinkDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPasswordResetLinkDataService>() as TSupports;
        }		
