...
{	
	[TestFixture]
    public partial class VisitorDataServiceTests : VisitorDataServiceTestsBase
    {
	}
    ...
    {
		protected IVisitorDataService DataService {get { return this.DependencyResolver.Resolve<IVisitorDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IVisitorDataService>() as TSupports;
        }		
