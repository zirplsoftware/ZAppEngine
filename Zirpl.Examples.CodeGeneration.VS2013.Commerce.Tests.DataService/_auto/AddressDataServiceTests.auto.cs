...
{	
	[TestFixture]
    public partial class AddressDataServiceTests : AddressDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class AddressDataServiceTestsBase : EntityLayerTestFixtureBase<Address, int, AddressEntityWrapper, AddressTestsStrategy>
    {
		protected IAddressDataService DataService {get { return this.DependencyResolver.Resolve<IAddressDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IAddressDataService>() as TSupports;
        }		
