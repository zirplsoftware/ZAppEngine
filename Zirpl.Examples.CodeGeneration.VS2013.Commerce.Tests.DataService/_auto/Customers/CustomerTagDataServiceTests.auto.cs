...
{	
	[TestFixture]
    public partial class CustomerTagDataServiceTests : CustomerTagDataServiceTestsBase
    {
	}
    ...
    {
		protected ICustomerTagDataService DataService {get { return this.DependencyResolver.Resolve<ICustomerTagDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ICustomerTagDataService>() as TSupports;
        }		
