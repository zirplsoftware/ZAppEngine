...
{	
	[TestFixture]
    public partial class CustomerDataServiceTests : CustomerDataServiceTestsBase
    {
	}
    ...
    {
		protected ICustomerDataService DataService {get { return this.DependencyResolver.Resolve<ICustomerDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ICustomerDataService>() as TSupports;
        }		
