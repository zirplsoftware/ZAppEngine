...
namespace Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.DataService.Customers
{	
	[TestFixture]
    public partial class CustomerChargeOptionDataServiceTests : CustomerChargeOptionDataServiceTestsBase
    {
	}
    ...
    {
		protected ICustomerChargeOptionDataService DataService {get { return this.DependencyResolver.Resolve<ICustomerChargeOptionDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ICustomerChargeOptionDataService>() as TSupports;
        }		
