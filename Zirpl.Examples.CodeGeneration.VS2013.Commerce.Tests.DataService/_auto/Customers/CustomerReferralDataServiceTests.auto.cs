...
{	
	[TestFixture]
    public partial class CustomerReferralDataServiceTests : CustomerReferralDataServiceTestsBase
    {
	}
    ...
    {
		protected ICustomerReferralDataService DataService {get { return this.DependencyResolver.Resolve<ICustomerReferralDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ICustomerReferralDataService>() as TSupports;
        }		
