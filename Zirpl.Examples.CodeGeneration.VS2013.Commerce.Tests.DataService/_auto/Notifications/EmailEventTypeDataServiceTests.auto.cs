...
{
	[TestFixture]
    public partial class EmailEventTypeDataServiceTests : EmailEventTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected IEmailEventTypeDataService DataService {get { return this.DependencyResolver.Resolve<IEmailEventTypeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IEmailEventTypeDataService>() as TSupports;
        }		
