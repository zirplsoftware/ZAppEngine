...
{	
	[TestFixture]
    public partial class SubscriptionDataServiceTests : SubscriptionDataServiceTestsBase
    {
	}
    ...
    {
		protected ISubscriptionDataService DataService {get { return this.DependencyResolver.Resolve<ISubscriptionDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionDataService>() as TSupports;
        }		
