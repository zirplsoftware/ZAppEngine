...
{	
	[TestFixture]
    public partial class SubscriptionInstanceDataServiceTests : SubscriptionInstanceDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class SubscriptionInstanceDataServiceTestsBase : EntityLayerTestFixtureBase<SubscriptionInstance, int, SubscriptionInstanceEntityWrapper, SubscriptionInstanceTestsStrategy>
    {
		protected ISubscriptionInstanceDataService DataService {get { return this.DependencyResolver.Resolve<ISubscriptionInstanceDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionInstanceDataService>() as TSupports;
        }		
