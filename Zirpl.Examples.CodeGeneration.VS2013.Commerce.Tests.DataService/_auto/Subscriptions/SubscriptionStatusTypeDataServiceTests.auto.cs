...
{
	[TestFixture]
    public partial class SubscriptionStatusTypeDataServiceTests : SubscriptionStatusTypeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class SubscriptionStatusTypeDataServiceTestsBase : DictionaryEntityLayerTestFixtureBase<SubscriptionStatusType, byte, SubscriptionStatusTypeEnum>
    {
		protected ISubscriptionStatusTypeDataService DataService {get { return this.DependencyResolver.Resolve<ISubscriptionStatusTypeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionStatusTypeDataService>() as TSupports;
        }		
