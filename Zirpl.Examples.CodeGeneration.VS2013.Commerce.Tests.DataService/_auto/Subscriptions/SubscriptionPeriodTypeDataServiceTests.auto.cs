...
{
	[TestFixture]
    public partial class SubscriptionPeriodTypeDataServiceTests : SubscriptionPeriodTypeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class SubscriptionPeriodTypeDataServiceTestsBase : DictionaryEntityLayerTestFixtureBase<SubscriptionPeriodType, byte, SubscriptionPeriodTypeEnum>
    {
		protected ISubscriptionPeriodTypeDataService DataService {get { return this.DependencyResolver.Resolve<ISubscriptionPeriodTypeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionPeriodTypeDataService>() as TSupports;
        }		
