...
{	
	[TestFixture]
    public partial class SubscriptionPeriodDataServiceTests : SubscriptionPeriodDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class SubscriptionPeriodDataServiceTestsBase : EntityLayerTestFixtureBase<SubscriptionPeriod, int, SubscriptionPeriodEntityWrapper, SubscriptionPeriodTestsStrategy>
    {
		protected ISubscriptionPeriodDataService DataService {get { return this.DependencyResolver.Resolve<ISubscriptionPeriodDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionPeriodDataService>() as TSupports;
        }		
