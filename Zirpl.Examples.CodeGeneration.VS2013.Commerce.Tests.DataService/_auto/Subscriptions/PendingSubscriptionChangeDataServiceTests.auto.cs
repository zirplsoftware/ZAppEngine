...
namespace Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.DataService.Subscriptions
{	
	[TestFixture]
    public partial class PendingSubscriptionChangeDataServiceTests : PendingSubscriptionChangeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class PendingSubscriptionChangeDataServiceTestsBase : EntityLayerTestFixtureBase<PendingSubscriptionChange, int, PendingSubscriptionChangeEntityWrapper, PendingSubscriptionChangeTestsStrategy>
    {
		protected IPendingSubscriptionChangeDataService DataService {get { return this.DependencyResolver.Resolve<IPendingSubscriptionChangeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPendingSubscriptionChangeDataService>() as TSupports;
        }		
