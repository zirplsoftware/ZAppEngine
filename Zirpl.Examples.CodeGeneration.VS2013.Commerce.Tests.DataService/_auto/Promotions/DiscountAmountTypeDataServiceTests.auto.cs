...
{
	[TestFixture]
    public partial class DiscountAmountTypeDataServiceTests : DiscountAmountTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected IDiscountAmountTypeDataService DataService {get { return this.DependencyResolver.Resolve<IDiscountAmountTypeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IDiscountAmountTypeDataService>() as TSupports;
        }		
