...
{	
	[TestFixture]
    public partial class ReferralDataServiceTests : ReferralDataServiceTestsBase
    {
	}
    ...
    {
		protected IReferralDataService DataService {get { return this.DependencyResolver.Resolve<IReferralDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IReferralDataService>() as TSupports;
        }		
