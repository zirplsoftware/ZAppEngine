...
{	
	[TestFixture]
    public partial class PromoCodeDataServiceTests : PromoCodeDataServiceTestsBase
    {
	}
    ...
    {
		protected IPromoCodeDataService DataService {get { return this.DependencyResolver.Resolve<IPromoCodeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPromoCodeDataService>() as TSupports;
        }		
