...
{	
	[TestFixture]
    public partial class DiscountDataServiceTests : DiscountDataServiceTestsBase
    {
	}
    ...
    {
		protected IDiscountDataService DataService {get { return this.DependencyResolver.Resolve<IDiscountDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IDiscountDataService>() as TSupports;
        }		
