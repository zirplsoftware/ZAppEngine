...
namespace Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.DataService.Promotions
{
	[TestFixture]
    public partial class DiscountApplicabilityTypeDataServiceTests : DiscountApplicabilityTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected IDiscountApplicabilityTypeDataService DataService {get { return this.DependencyResolver.Resolve<IDiscountApplicabilityTypeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IDiscountApplicabilityTypeDataService>() as TSupports;
        }		
