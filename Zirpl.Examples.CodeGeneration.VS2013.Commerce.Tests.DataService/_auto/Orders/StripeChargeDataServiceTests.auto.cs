...
{	
	[TestFixture]
    public partial class StripeChargeDataServiceTests : StripeChargeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class StripeChargeDataServiceTestsBase : EntityLayerTestFixtureBase<StripeCharge, int, StripeChargeEntityWrapper, StripeChargeTestsStrategy>
    {
		protected IStripeChargeDataService DataService {get { return this.DependencyResolver.Resolve<IStripeChargeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IStripeChargeDataService>() as TSupports;
        }		
