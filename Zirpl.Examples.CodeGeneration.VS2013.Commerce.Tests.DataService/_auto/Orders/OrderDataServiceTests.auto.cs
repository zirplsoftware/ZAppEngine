...
{	
	[TestFixture]
    public partial class OrderDataServiceTests : OrderDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class OrderDataServiceTestsBase : EntityLayerTestFixtureBase<Order, int, OrderEntityWrapper, OrderTestsStrategy>
    {
		protected IOrderDataService DataService {get { return this.DependencyResolver.Resolve<IOrderDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IOrderDataService>() as TSupports;
        }		
