...
{
	[TestFixture]
    public partial class ChargeMethodTypeDataServiceTests : ChargeMethodTypeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class ChargeMethodTypeDataServiceTestsBase : DictionaryEntityLayerTestFixtureBase<ChargeMethodType, byte, ChargeMethodTypeEnum>
    {
		protected IChargeMethodTypeDataService DataService {get { return this.DependencyResolver.Resolve<IChargeMethodTypeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IChargeMethodTypeDataService>() as TSupports;
        }		
