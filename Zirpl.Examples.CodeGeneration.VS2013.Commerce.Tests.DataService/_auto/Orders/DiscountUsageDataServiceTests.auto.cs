...
{	
	[TestFixture]
    public partial class DiscountUsageDataServiceTests : DiscountUsageDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class DiscountUsageDataServiceTestsBase : EntityLayerTestFixtureBase<DiscountUsage, int, DiscountUsageEntityWrapper, DiscountUsageTestsStrategy>
    {
		protected IDiscountUsageDataService DataService {get { return this.DependencyResolver.Resolve<IDiscountUsageDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IDiscountUsageDataService>() as TSupports;
        }		
