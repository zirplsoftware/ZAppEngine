...
{	
	[TestFixture]
    public partial class StripeCustomerChargeOptionDataServiceTests : StripeCustomerChargeOptionDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class StripeCustomerChargeOptionDataServiceTestsBase : EntityLayerTestFixtureBase<StripeCustomerChargeOption, int, StripeCustomerChargeOptionEntityWrapper, StripeCustomerChargeOptionTestsStrategy>
    {
		protected IStripeCustomerChargeOptionDataService DataService {get { return this.DependencyResolver.Resolve<IStripeCustomerChargeOptionDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IStripeCustomerChargeOptionDataService>() as TSupports;
        }		
