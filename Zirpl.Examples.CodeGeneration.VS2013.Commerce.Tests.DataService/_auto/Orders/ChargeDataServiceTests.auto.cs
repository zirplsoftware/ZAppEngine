...
{	
	[TestFixture]
    public partial class ChargeDataServiceTests : ChargeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class ChargeDataServiceTestsBase : EntityLayerTestFixtureBase<Charge, int, ChargeEntityWrapper, ChargeTestsStrategy>
    {
		protected IChargeDataService DataService {get { return this.DependencyResolver.Resolve<IChargeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IChargeDataService>() as TSupports;
        }		
