...
{
	[TestFixture]
    public partial class ChargeStatusTypeDataServiceTests : ChargeStatusTypeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class ChargeStatusTypeDataServiceTestsBase : DictionaryEntityLayerTestFixtureBase<ChargeStatusType, byte, ChargeStatusTypeEnum>
    {
		protected IChargeStatusTypeDataService DataService {get { return this.DependencyResolver.Resolve<IChargeStatusTypeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IChargeStatusTypeDataService>() as TSupports;
        }		
