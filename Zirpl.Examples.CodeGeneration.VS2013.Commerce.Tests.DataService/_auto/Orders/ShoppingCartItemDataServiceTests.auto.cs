...
{	
	[TestFixture]
    public partial class ShoppingCartItemDataServiceTests : ShoppingCartItemDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class ShoppingCartItemDataServiceTestsBase : EntityLayerTestFixtureBase<ShoppingCartItem, int, ShoppingCartItemEntityWrapper, ShoppingCartItemTestsStrategy>
    {
		protected IShoppingCartItemDataService DataService {get { return this.DependencyResolver.Resolve<IShoppingCartItemDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IShoppingCartItemDataService>() as TSupports;
        }		
