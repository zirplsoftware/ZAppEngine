...
{	
	[TestFixture]
    public partial class OrderItemDataServiceTests : OrderItemDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class OrderItemDataServiceTestsBase : EntityLayerTestFixtureBase<OrderItem, int, OrderItemEntityWrapper, OrderItemTestsStrategy>
    {
		protected IOrderItemDataService DataService {get { return this.DependencyResolver.Resolve<IOrderItemDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IOrderItemDataService>() as TSupports;
        }		
