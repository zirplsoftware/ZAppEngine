...
{
	[TestFixture]
    public partial class OrderChargeStatusTypeDataServiceTests : OrderChargeStatusTypeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class OrderChargeStatusTypeDataServiceTestsBase : DictionaryEntityLayerTestFixtureBase<OrderChargeStatusType, byte, OrderChargeStatusTypeEnum>
    {
		protected IOrderChargeStatusTypeDataService DataService {get { return this.DependencyResolver.Resolve<IOrderChargeStatusTypeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IOrderChargeStatusTypeDataService>() as TSupports;
        }		
