...
{
	[TestFixture]
    public partial class DiscountUsageRestrictionTypeDataServiceTests : DiscountUsageRestrictionTypeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class DiscountUsageRestrictionTypeDataServiceTestsBase : DictionaryEntityLayerTestFixtureBase<DiscountUsageRestrictionType, byte, DiscountUsageRestrictionTypeEnum>
    {
		protected IDiscountUsageRestrictionTypeDataService DataService {get { return this.DependencyResolver.Resolve<IDiscountUsageRestrictionTypeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IDiscountUsageRestrictionTypeDataService>() as TSupports;
        }		
