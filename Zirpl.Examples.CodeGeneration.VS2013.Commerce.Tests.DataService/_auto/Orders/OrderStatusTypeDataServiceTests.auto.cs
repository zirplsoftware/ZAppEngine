...
{
	[TestFixture]
    public partial class OrderStatusTypeDataServiceTests : OrderStatusTypeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class OrderStatusTypeDataServiceTestsBase : DictionaryEntityLayerTestFixtureBase<OrderStatusType, byte, OrderStatusTypeEnum>
    {
		protected IOrderStatusTypeDataService DataService {get { return this.DependencyResolver.Resolve<IOrderStatusTypeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IOrderStatusTypeDataService>() as TSupports;
        }		
