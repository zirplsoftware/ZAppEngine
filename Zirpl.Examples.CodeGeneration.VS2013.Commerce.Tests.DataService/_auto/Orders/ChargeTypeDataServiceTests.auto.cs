...
{
	[TestFixture]
    public partial class ChargeTypeDataServiceTests : ChargeTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected IChargeTypeDataService DataService {get { return this.DependencyResolver.Resolve<IChargeTypeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IChargeTypeDataService>() as TSupports;
        }		
