...
{	
	[TestFixture]
    public partial class SubscriptionOrderItemDataServiceTests : SubscriptionOrderItemDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class SubscriptionOrderItemDataServiceTestsBase : EntityLayerTestFixtureBase<SubscriptionOrderItem, int, SubscriptionOrderItemEntityWrapper, SubscriptionOrderItemTestsStrategy>
    {
		protected ISubscriptionOrderItemDataService DataService {get { return this.DependencyResolver.Resolve<ISubscriptionOrderItemDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionOrderItemDataService>() as TSupports;
        }		
