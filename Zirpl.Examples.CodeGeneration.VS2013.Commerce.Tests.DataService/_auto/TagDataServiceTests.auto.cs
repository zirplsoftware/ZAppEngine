...
{	
	[TestFixture]
    public partial class TagDataServiceTests : TagDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class TagDataServiceTestsBase : EntityLayerTestFixtureBase<Tag, int, TagEntityWrapper, TagTestsStrategy>
    {
		protected ITagDataService DataService {get { return this.DependencyResolver.Resolve<ITagDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ITagDataService>() as TSupports;
        }		
