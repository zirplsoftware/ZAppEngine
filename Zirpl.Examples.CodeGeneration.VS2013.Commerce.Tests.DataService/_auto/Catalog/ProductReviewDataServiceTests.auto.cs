...
{	
	[TestFixture]
    public partial class ProductReviewDataServiceTests : ProductReviewDataServiceTestsBase
    {
	}
    ...
    {
		protected IProductReviewDataService DataService {get { return this.DependencyResolver.Resolve<IProductReviewDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IProductReviewDataService>() as TSupports;
        }		
