...
{	
	[TestFixture]
    public partial class DisplayProductDataServiceTests : DisplayProductDataServiceTestsBase
    {
	}
    ...
    {
		protected IDisplayProductDataService DataService {get { return this.DependencyResolver.Resolve<IDisplayProductDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IDisplayProductDataService>() as TSupports;
        }		
