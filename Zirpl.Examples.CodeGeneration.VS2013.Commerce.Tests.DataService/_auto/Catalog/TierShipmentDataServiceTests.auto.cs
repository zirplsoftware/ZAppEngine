...
{	
	[TestFixture]
    public partial class TierShipmentDataServiceTests : TierShipmentDataServiceTestsBase
    {
	}
    ...
    {
		protected ITierShipmentDataService DataService {get { return this.DependencyResolver.Resolve<ITierShipmentDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ITierShipmentDataService>() as TSupports;
        }		
