...
namespace Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.DataService.Catalog
{	
	[TestFixture]
    public partial class SubscriptionChoiceTierPriceCombinationDataServiceTests : SubscriptionChoiceTierPriceCombinationDataServiceTestsBase
    {
	}
    ...
    {
		protected ISubscriptionChoiceTierPriceCombinationDataService DataService {get { return this.DependencyResolver.Resolve<ISubscriptionChoiceTierPriceCombinationDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionChoiceTierPriceCombinationDataService>() as TSupports;
        }		
