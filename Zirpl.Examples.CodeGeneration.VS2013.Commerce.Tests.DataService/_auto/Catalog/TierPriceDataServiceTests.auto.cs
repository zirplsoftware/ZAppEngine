...
{	
	[TestFixture]
    public partial class TierPriceDataServiceTests : TierPriceDataServiceTestsBase
    {
	}
    ...
    {
		protected ITierPriceDataService DataService {get { return this.DependencyResolver.Resolve<ITierPriceDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ITierPriceDataService>() as TSupports;
        }		
