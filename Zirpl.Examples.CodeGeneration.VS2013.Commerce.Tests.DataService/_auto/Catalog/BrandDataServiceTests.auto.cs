...
{	
	[TestFixture]
    public partial class BrandDataServiceTests : BrandDataServiceTestsBase
    {
	}
    ...
    {
		protected IBrandDataService DataService {get { return this.DependencyResolver.Resolve<IBrandDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IBrandDataService>() as TSupports;
        }		
