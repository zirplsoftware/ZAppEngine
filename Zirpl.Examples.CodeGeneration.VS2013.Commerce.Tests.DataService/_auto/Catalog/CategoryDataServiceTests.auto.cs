...
{	
	[TestFixture]
    public partial class CategoryDataServiceTests : CategoryDataServiceTestsBase
    {
	}
    ...
    {
		protected ICategoryDataService DataService {get { return this.DependencyResolver.Resolve<ICategoryDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ICategoryDataService>() as TSupports;
        }		
