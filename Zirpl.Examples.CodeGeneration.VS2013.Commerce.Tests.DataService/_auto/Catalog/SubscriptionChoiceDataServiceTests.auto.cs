...
{	
	[TestFixture]
    public partial class SubscriptionChoiceDataServiceTests : SubscriptionChoiceDataServiceTestsBase
    {
	}
    ...
    {
		protected ISubscriptionChoiceDataService DataService {get { return this.DependencyResolver.Resolve<ISubscriptionChoiceDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionChoiceDataService>() as TSupports;
        }		
