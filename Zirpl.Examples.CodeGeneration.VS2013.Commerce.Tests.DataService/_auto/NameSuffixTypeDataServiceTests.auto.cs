...
{
	[TestFixture]
    public partial class NameSuffixTypeDataServiceTests : NameSuffixTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected INameSuffixTypeDataService DataService {get { return this.DependencyResolver.Resolve<INameSuffixTypeDataService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<INameSuffixTypeDataService>() as TSupports;
        }		
