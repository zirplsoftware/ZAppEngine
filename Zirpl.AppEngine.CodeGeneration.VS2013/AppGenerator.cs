    ...
    public static class AppGenerator
    {
        public static void GenerateApp(this TextTransformation callingTemplate, V1Helper helper = null)
        {
            using (helper = helper ?? new V1Helper(callingTemplate))
            {
                ...
                new Zirpl.AppEngine.CodeGeneration.V1.Templates.Tests.DataService.EntityFramework.DataServiceTestsTemplate(helper).TransformText();
                new Zirpl.AppEngine.CodeGeneration.V1.Templates.Tests.Service.ServicesProviderTemplate(helper).TransformText();
                new Zirpl.AppEngine.CodeGeneration.V1.Templates.Tests.Service.EntityFramework.ServiceTestsTemplate(helper).TransformText();
            }
        }
    }
}
