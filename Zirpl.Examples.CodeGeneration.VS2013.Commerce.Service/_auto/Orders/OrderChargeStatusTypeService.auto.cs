...
{
    public partial class OrderChargeStatusTypeService  : DictionaryEntityService<CommerceDataContext, OrderChargeStatusType, byte, OrderChargeStatusTypeEnum>, IOrderChargeStatusTypeService
    {
    }
}
