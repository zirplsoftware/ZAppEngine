...
{
    public partial class StripeCustomerChargeOptionService  : DbContextServiceBase<CommerceDataContext, StripeCustomerChargeOption, int>, IStripeCustomerChargeOptionService
    {
    }
}
