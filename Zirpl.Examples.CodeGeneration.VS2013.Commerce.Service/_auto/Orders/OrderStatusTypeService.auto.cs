...
{
    public partial class OrderStatusTypeService  : DictionaryEntityService<CommerceDataContext, OrderStatusType, byte, OrderStatusTypeEnum>, IOrderStatusTypeService
    {
    }
}
