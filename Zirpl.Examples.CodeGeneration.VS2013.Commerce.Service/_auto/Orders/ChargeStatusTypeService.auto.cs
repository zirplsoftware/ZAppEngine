...
{
    public partial class ChargeStatusTypeService  : DictionaryEntityService<CommerceDataContext, ChargeStatusType, byte, ChargeStatusTypeEnum>, IChargeStatusTypeService
    {
    }
}
