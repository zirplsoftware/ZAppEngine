...
{
    public partial class PendingSubscriptionChangeService  : DbContextServiceBase<CommerceDataContext, PendingSubscriptionChange, int>, IPendingSubscriptionChangeService
    {
    }
}
