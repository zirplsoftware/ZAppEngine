...
{
    public partial class SubscriptionPeriodTypeService  : DictionaryEntityService<CommerceDataContext, SubscriptionPeriodType, byte, SubscriptionPeriodTypeEnum>, ISubscriptionPeriodTypeService
    {
    }
}
