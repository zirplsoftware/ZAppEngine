...
{
    public partial class SubscriptionChoiceTierPriceCombinationService  : DbContextServiceBase<CommerceDataContext, SubscriptionChoiceTierPriceCombination, int>, ISubscriptionChoiceTierPriceCombinationService
    {
    }
}
