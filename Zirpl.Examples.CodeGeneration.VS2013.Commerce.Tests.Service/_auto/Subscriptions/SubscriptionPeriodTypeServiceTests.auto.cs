...
{
	[TestFixture]
    public partial class SubscriptionPeriodTypeServiceTests : SubscriptionPeriodTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected ISubscriptionPeriodTypeService Service {get { return this.DependencyResolver.Resolve<ISubscriptionPeriodTypeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionPeriodTypeService>() as TSupports;
        }		
