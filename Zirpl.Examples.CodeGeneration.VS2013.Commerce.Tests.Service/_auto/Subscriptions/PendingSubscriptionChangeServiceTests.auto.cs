...
{	
	[TestFixture]
    public partial class PendingSubscriptionChangeServiceTests : PendingSubscriptionChangeDataServiceTestsBase
    {
	}
    ...
    {
		protected IPendingSubscriptionChangeService Service {get { return this.DependencyResolver.Resolve<IPendingSubscriptionChangeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPendingSubscriptionChangeService>() as TSupports;
        }		
