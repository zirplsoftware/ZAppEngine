...
{	
	[TestFixture]
    public partial class SubscriptionInstanceServiceTests : SubscriptionInstanceDataServiceTestsBase
    {
	}
    ...
    {
		protected ISubscriptionInstanceService Service {get { return this.DependencyResolver.Resolve<ISubscriptionInstanceService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionInstanceService>() as TSupports;
        }		
