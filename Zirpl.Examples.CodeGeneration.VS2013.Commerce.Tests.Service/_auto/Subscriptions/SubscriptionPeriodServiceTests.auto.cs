...
{	
	[TestFixture]
    public partial class SubscriptionPeriodServiceTests : SubscriptionPeriodDataServiceTestsBase
    {
	}
    ...
    {
		protected ISubscriptionPeriodService Service {get { return this.DependencyResolver.Resolve<ISubscriptionPeriodService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionPeriodService>() as TSupports;
        }		
