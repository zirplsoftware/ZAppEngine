...
{
	[TestFixture]
    public partial class SubscriptionStatusTypeServiceTests : SubscriptionStatusTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected ISubscriptionStatusTypeService Service {get { return this.DependencyResolver.Resolve<ISubscriptionStatusTypeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionStatusTypeService>() as TSupports;
        }		
