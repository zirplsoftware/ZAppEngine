...
{
	[TestFixture]
    public partial class ChargeStatusTypeServiceTests : ChargeStatusTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected IChargeStatusTypeService Service {get { return this.DependencyResolver.Resolve<IChargeStatusTypeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IChargeStatusTypeService>() as TSupports;
        }		
