...
{
	[TestFixture]
    public partial class DiscountUsageRestrictionTypeServiceTests : DiscountUsageRestrictionTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected IDiscountUsageRestrictionTypeService Service {get { return this.DependencyResolver.Resolve<IDiscountUsageRestrictionTypeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IDiscountUsageRestrictionTypeService>() as TSupports;
        }		
