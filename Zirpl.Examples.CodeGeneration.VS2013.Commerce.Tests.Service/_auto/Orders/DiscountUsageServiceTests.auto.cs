...
{	
	[TestFixture]
    public partial class DiscountUsageServiceTests : DiscountUsageDataServiceTestsBase
    {
	}
    ...
    {
		protected IDiscountUsageService Service {get { return this.DependencyResolver.Resolve<IDiscountUsageService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IDiscountUsageService>() as TSupports;
        }		
