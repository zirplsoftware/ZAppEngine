...
{	
	[TestFixture]
    public partial class OrderServiceTests : OrderDataServiceTestsBase
    {
	}
    ...
    {
		protected IOrderService Service {get { return this.DependencyResolver.Resolve<IOrderService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IOrderService>() as TSupports;
        }		
