...
{
	[TestFixture]
    public partial class SubscriptionOrderItemTypeServiceTests : SubscriptionOrderItemTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected ISubscriptionOrderItemTypeService Service {get { return this.DependencyResolver.Resolve<ISubscriptionOrderItemTypeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionOrderItemTypeService>() as TSupports;
        }		
