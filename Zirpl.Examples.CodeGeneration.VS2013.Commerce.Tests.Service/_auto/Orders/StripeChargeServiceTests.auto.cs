...
{	
	[TestFixture]
    public partial class StripeChargeServiceTests : StripeChargeDataServiceTestsBase
    {
	}
    ...
    {
		protected IStripeChargeService Service {get { return this.DependencyResolver.Resolve<IStripeChargeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IStripeChargeService>() as TSupports;
        }		
