...
{
	[TestFixture]
    public partial class OrderStatusTypeServiceTests : OrderStatusTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected IOrderStatusTypeService Service {get { return this.DependencyResolver.Resolve<IOrderStatusTypeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IOrderStatusTypeService>() as TSupports;
        }		
