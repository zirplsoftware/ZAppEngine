...
{	
	[TestFixture]
    public partial class ShoppingCartItemServiceTests : ShoppingCartItemDataServiceTestsBase
    {
	}
    ...
    {
		protected IShoppingCartItemService Service {get { return this.DependencyResolver.Resolve<IShoppingCartItemService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IShoppingCartItemService>() as TSupports;
        }		
