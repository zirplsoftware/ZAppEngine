...
{	
	[TestFixture]
    public partial class SubscriptionOrderItemServiceTests : SubscriptionOrderItemDataServiceTestsBase
    {
	}
    ...
    {
		protected ISubscriptionOrderItemService Service {get { return this.DependencyResolver.Resolve<ISubscriptionOrderItemService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionOrderItemService>() as TSupports;
        }		
