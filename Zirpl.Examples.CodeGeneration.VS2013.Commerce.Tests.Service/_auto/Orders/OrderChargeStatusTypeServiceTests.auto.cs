...
{
	[TestFixture]
    public partial class OrderChargeStatusTypeServiceTests : OrderChargeStatusTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected IOrderChargeStatusTypeService Service {get { return this.DependencyResolver.Resolve<IOrderChargeStatusTypeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IOrderChargeStatusTypeService>() as TSupports;
        }		
