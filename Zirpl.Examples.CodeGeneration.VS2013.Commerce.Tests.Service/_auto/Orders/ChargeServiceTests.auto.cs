...
{	
	[TestFixture]
    public partial class ChargeServiceTests : ChargeDataServiceTestsBase
    {
	}
    ...
    {
		protected IChargeService Service {get { return this.DependencyResolver.Resolve<IChargeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IChargeService>() as TSupports;
        }		
