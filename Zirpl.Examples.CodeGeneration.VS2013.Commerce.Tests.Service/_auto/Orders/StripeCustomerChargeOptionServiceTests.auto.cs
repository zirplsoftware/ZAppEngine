...
{	
	[TestFixture]
    public partial class StripeCustomerChargeOptionServiceTests : StripeCustomerChargeOptionDataServiceTestsBase
    {
	}
    ...
    {
		protected IStripeCustomerChargeOptionService Service {get { return this.DependencyResolver.Resolve<IStripeCustomerChargeOptionService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IStripeCustomerChargeOptionService>() as TSupports;
        }		
