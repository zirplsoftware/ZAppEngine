...
{	
	[TestFixture]
    public partial class OrderItemServiceTests : OrderItemDataServiceTestsBase
    {
	}
    ...
    {
		protected IOrderItemService Service {get { return this.DependencyResolver.Resolve<IOrderItemService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IOrderItemService>() as TSupports;
        }		
