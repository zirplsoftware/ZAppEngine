...
{
	[TestFixture]
    public partial class ChargeMethodTypeServiceTests : ChargeMethodTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected IChargeMethodTypeService Service {get { return this.DependencyResolver.Resolve<IChargeMethodTypeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IChargeMethodTypeService>() as TSupports;
        }		
