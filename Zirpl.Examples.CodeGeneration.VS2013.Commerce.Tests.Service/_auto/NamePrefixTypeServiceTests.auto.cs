...
{
	[TestFixture]
    public partial class NamePrefixTypeServiceTests : NamePrefixTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected INamePrefixTypeService Service {get { return this.DependencyResolver.Resolve<INamePrefixTypeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<INamePrefixTypeService>() as TSupports;
        }		
