...
{	
	[TestFixture]
    public partial class PartnerReferralCouponRequestServiceTests : PartnerReferralCouponRequestDataServiceTestsBase
    {
	}
    ...
    {
		protected IPartnerReferralCouponRequestService Service {get { return this.DependencyResolver.Resolve<IPartnerReferralCouponRequestService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPartnerReferralCouponRequestService>() as TSupports;
        }		
