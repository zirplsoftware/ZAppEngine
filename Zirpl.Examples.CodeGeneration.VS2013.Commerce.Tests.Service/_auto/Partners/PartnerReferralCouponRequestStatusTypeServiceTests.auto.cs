...
namespace Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.Service.Partners
{
	[TestFixture]
    public partial class PartnerReferralCouponRequestStatusTypeServiceTests : PartnerReferralCouponRequestStatusTypeDataServiceTestsBase
    {
	}
    ...
    {
		protected IPartnerReferralCouponRequestStatusTypeService Service {get { return this.DependencyResolver.Resolve<IPartnerReferralCouponRequestStatusTypeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPartnerReferralCouponRequestStatusTypeService>() as TSupports;
        }		
