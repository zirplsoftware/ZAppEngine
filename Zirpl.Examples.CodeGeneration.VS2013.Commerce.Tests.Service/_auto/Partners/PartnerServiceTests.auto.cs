...
{	
	[TestFixture]
    public partial class PartnerServiceTests : PartnerDataServiceTestsBase
    {
	}
    ...
    {
		protected IPartnerService Service {get { return this.DependencyResolver.Resolve<IPartnerService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPartnerService>() as TSupports;
        }		
