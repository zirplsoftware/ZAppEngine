...
{	
	[TestFixture]
    public partial class PartnerReferralServiceTests : PartnerReferralDataServiceTestsBase
    {
	}
    ...
    {
		protected IPartnerReferralService Service {get { return this.DependencyResolver.Resolve<IPartnerReferralService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPartnerReferralService>() as TSupports;
        }		
