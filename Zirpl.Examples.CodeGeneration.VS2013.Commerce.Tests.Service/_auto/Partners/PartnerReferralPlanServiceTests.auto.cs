...
{	
	[TestFixture]
    public partial class PartnerReferralPlanServiceTests : PartnerReferralPlanDataServiceTestsBase
    {
	}
    ...
    {
		protected IPartnerReferralPlanService Service {get { return this.DependencyResolver.Resolve<IPartnerReferralPlanService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPartnerReferralPlanService>() as TSupports;
        }		
