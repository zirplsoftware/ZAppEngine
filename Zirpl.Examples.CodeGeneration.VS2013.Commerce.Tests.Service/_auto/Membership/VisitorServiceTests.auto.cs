...
{	
	[TestFixture]
    public partial class VisitorServiceTests : VisitorDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class VisitorDataServiceTestsBase : EntityLayerTestFixtureBase<Visitor, int, VisitorEntityWrapper, VisitorTestsStrategy>
    {
		protected IVisitorService Service {get { return this.DependencyResolver.Resolve<IVisitorService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IVisitorService>() as TSupports;
        }		
