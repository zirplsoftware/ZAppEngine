...
using Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.Membership;
...
using Zirpl.Examples.CodeGeneration.VS2013.Commerce.Service.Membership;

namespace Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.Service.Membership
{	
	[TestFixture]
    public partial class PasswordResetLinkServiceTests : PasswordResetLinkDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class PasswordResetLinkDataServiceTestsBase : EntityLayerTestFixtureBase<PasswordResetLink, int, PasswordResetLinkEntityWrapper, PasswordResetLinkTestsStrategy>
    {
		protected IPasswordResetLinkService Service {get { return this.DependencyResolver.Resolve<IPasswordResetLinkService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPasswordResetLinkService>() as TSupports;
        }		
