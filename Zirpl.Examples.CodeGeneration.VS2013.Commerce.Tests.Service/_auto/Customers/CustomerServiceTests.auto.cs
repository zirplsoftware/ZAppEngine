...
{	
	[TestFixture]
    public partial class CustomerServiceTests : CustomerDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class CustomerDataServiceTestsBase : EntityLayerTestFixtureBase<Customer, int, CustomerEntityWrapper, CustomerTestsStrategy>
    {
		protected ICustomerService Service {get { return this.DependencyResolver.Resolve<ICustomerService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ICustomerService>() as TSupports;
        }		
