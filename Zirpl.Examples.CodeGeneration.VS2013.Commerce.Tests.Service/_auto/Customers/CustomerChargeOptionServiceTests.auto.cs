...
using Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.Customers;
...
using Zirpl.Examples.CodeGeneration.VS2013.Commerce.Service.Customers;

namespace Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.Service.Customers
{	
	[TestFixture]
    public partial class CustomerChargeOptionServiceTests : CustomerChargeOptionDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class CustomerChargeOptionDataServiceTestsBase : EntityLayerTestFixtureBase<CustomerChargeOption, int, CustomerChargeOptionEntityWrapper, CustomerChargeOptionTestsStrategy>
    {
		protected ICustomerChargeOptionService Service {get { return this.DependencyResolver.Resolve<ICustomerChargeOptionService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ICustomerChargeOptionService>() as TSupports;
        }		
