...
{	
	[TestFixture]
    public partial class CustomerTagServiceTests : CustomerTagDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class CustomerTagDataServiceTestsBase : EntityLayerTestFixtureBase<CustomerTag, int, CustomerTagEntityWrapper, CustomerTagTestsStrategy>
    {
		protected ICustomerTagService Service {get { return this.DependencyResolver.Resolve<ICustomerTagService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ICustomerTagService>() as TSupports;
        }		
