...
{	
	[TestFixture]
    public partial class CustomerReferralServiceTests : CustomerReferralDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class CustomerReferralDataServiceTestsBase : EntityLayerTestFixtureBase<CustomerReferral, int, CustomerReferralEntityWrapper, CustomerReferralTestsStrategy>
    {
		protected ICustomerReferralService Service {get { return this.DependencyResolver.Resolve<ICustomerReferralService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ICustomerReferralService>() as TSupports;
        }		
