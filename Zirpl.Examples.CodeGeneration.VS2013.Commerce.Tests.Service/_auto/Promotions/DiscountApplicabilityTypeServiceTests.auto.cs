...
using Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.Promotions;
...
using Zirpl.Examples.CodeGeneration.VS2013.Commerce.Service.Promotions;

namespace Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.Service.Promotions
{
	[TestFixture]
    public partial class DiscountApplicabilityTypeServiceTests : DiscountApplicabilityTypeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class DiscountApplicabilityTypeDataServiceTestsBase : DictionaryEntityLayerTestFixtureBase<DiscountApplicabilityType, byte, DiscountApplicabilityTypeEnum>
    {
		protected IDiscountApplicabilityTypeService Service {get { return this.DependencyResolver.Resolve<IDiscountApplicabilityTypeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IDiscountApplicabilityTypeService>() as TSupports;
        }		
