...
{	
	[TestFixture]
    public partial class PromoCodeServiceTests : PromoCodeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class PromoCodeDataServiceTestsBase : EntityLayerTestFixtureBase<PromoCode, int, PromoCodeEntityWrapper, PromoCodeTestsStrategy>
    {
		protected IPromoCodeService Service {get { return this.DependencyResolver.Resolve<IPromoCodeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IPromoCodeService>() as TSupports;
        }		
