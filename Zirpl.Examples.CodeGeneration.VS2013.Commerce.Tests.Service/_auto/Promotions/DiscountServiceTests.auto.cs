...
{	
	[TestFixture]
    public partial class DiscountServiceTests : DiscountDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class DiscountDataServiceTestsBase : EntityLayerTestFixtureBase<Discount, int, DiscountEntityWrapper, DiscountTestsStrategy>
    {
		protected IDiscountService Service {get { return this.DependencyResolver.Resolve<IDiscountService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IDiscountService>() as TSupports;
        }		
