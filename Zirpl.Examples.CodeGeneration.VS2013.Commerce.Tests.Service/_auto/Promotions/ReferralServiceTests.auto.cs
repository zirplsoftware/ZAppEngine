...
{	
	[TestFixture]
    public partial class ReferralServiceTests : ReferralDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class ReferralDataServiceTestsBase : EntityLayerTestFixtureBase<Referral, int, ReferralEntityWrapper, ReferralTestsStrategy>
    {
		protected IReferralService Service {get { return this.DependencyResolver.Resolve<IReferralService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IReferralService>() as TSupports;
        }		
