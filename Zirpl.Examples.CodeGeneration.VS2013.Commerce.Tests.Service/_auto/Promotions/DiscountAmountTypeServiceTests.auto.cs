...
{
	[TestFixture]
    public partial class DiscountAmountTypeServiceTests : DiscountAmountTypeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class DiscountAmountTypeDataServiceTestsBase : DictionaryEntityLayerTestFixtureBase<DiscountAmountType, byte, DiscountAmountTypeEnum>
    {
		protected IDiscountAmountTypeService Service {get { return this.DependencyResolver.Resolve<IDiscountAmountTypeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IDiscountAmountTypeService>() as TSupports;
        }		
