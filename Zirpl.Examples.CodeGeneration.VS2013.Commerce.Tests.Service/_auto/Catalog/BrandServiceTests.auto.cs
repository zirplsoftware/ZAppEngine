...
{	
	[TestFixture]
    public partial class BrandServiceTests : BrandDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class BrandDataServiceTestsBase : EntityLayerTestFixtureBase<Brand, int, BrandEntityWrapper, BrandTestsStrategy>
    {
		protected IBrandService Service {get { return this.DependencyResolver.Resolve<IBrandService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IBrandService>() as TSupports;
        }		
