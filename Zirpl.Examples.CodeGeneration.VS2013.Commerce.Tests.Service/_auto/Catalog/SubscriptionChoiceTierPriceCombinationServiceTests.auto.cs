...
using Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.Catalog;
...
using Zirpl.Examples.CodeGeneration.VS2013.Commerce.Service.Catalog;

namespace Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.Service.Catalog
{	
	[TestFixture]
    public partial class SubscriptionChoiceTierPriceCombinationServiceTests : SubscriptionChoiceTierPriceCombinationDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class SubscriptionChoiceTierPriceCombinationDataServiceTestsBase : EntityLayerTestFixtureBase<SubscriptionChoiceTierPriceCombination, int, SubscriptionChoiceTierPriceCombinationEntityWrapper, SubscriptionChoiceTierPriceCombinationTestsStrategy>
    {
		protected ISubscriptionChoiceTierPriceCombinationService Service {get { return this.DependencyResolver.Resolve<ISubscriptionChoiceTierPriceCombinationService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionChoiceTierPriceCombinationService>() as TSupports;
        }		
