...
{	
	[TestFixture]
    public partial class SubscriptionChoiceServiceTests : SubscriptionChoiceDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class SubscriptionChoiceDataServiceTestsBase : EntityLayerTestFixtureBase<SubscriptionChoice, int, SubscriptionChoiceEntityWrapper, SubscriptionChoiceTestsStrategy>
    {
		protected ISubscriptionChoiceService Service {get { return this.DependencyResolver.Resolve<ISubscriptionChoiceService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISubscriptionChoiceService>() as TSupports;
        }		
