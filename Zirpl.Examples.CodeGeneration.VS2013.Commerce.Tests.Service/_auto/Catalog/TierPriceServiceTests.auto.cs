...
{	
	[TestFixture]
    public partial class TierPriceServiceTests : TierPriceDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class TierPriceDataServiceTestsBase : EntityLayerTestFixtureBase<TierPrice, int, TierPriceEntityWrapper, TierPriceTestsStrategy>
    {
		protected ITierPriceService Service {get { return this.DependencyResolver.Resolve<ITierPriceService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ITierPriceService>() as TSupports;
        }		
