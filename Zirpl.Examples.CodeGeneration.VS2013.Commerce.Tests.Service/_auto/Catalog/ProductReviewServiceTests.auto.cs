...
{	
	[TestFixture]
    public partial class ProductReviewServiceTests : ProductReviewDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class ProductReviewDataServiceTestsBase : EntityLayerTestFixtureBase<ProductReview, int, ProductReviewEntityWrapper, ProductReviewTestsStrategy>
    {
		protected IProductReviewService Service {get { return this.DependencyResolver.Resolve<IProductReviewService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IProductReviewService>() as TSupports;
        }		
