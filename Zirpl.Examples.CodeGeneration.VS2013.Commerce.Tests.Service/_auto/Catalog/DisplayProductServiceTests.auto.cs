...
{	
	[TestFixture]
    public partial class DisplayProductServiceTests : DisplayProductDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class DisplayProductDataServiceTestsBase : EntityLayerTestFixtureBase<DisplayProduct, int, DisplayProductEntityWrapper, DisplayProductTestsStrategy>
    {
		protected IDisplayProductService Service {get { return this.DependencyResolver.Resolve<IDisplayProductService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IDisplayProductService>() as TSupports;
        }		
