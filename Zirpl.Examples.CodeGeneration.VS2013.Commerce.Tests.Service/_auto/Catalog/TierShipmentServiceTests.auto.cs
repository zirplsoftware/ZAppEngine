...
{	
	[TestFixture]
    public partial class TierShipmentServiceTests : TierShipmentDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class TierShipmentDataServiceTestsBase : EntityLayerTestFixtureBase<TierShipment, int, TierShipmentEntityWrapper, TierShipmentTestsStrategy>
    {
		protected ITierShipmentService Service {get { return this.DependencyResolver.Resolve<ITierShipmentService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ITierShipmentService>() as TSupports;
        }		
