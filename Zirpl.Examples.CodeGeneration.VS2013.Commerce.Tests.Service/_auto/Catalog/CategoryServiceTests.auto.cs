...
{	
	[TestFixture]
    public partial class CategoryServiceTests : CategoryDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class CategoryDataServiceTestsBase : EntityLayerTestFixtureBase<Category, int, CategoryEntityWrapper, CategoryTestsStrategy>
    {
		protected ICategoryService Service {get { return this.DependencyResolver.Resolve<ICategoryService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ICategoryService>() as TSupports;
        }		
