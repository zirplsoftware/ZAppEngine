...
{	
	[TestFixture]
    public partial class SystemSettingServiceTests : SystemSettingDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class SystemSettingDataServiceTestsBase : EntityLayerTestFixtureBase<SystemSetting, int, SystemSettingEntityWrapper, SystemSettingTestsStrategy>
    {
		protected ISystemSettingService Service {get { return this.DependencyResolver.Resolve<ISystemSettingService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ISystemSettingService>() as TSupports;
        }		
