...
using Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.Settings;
...
using Zirpl.Examples.CodeGeneration.VS2013.Commerce.Service.Settings;

namespace Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.Service.Settings
{
	[TestFixture]
    public partial class StateProvinceTypeServiceTests : StateProvinceTypeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class StateProvinceTypeDataServiceTestsBase : DictionaryEntityLayerTestFixtureBase<StateProvinceType, int, StateProvinceTypeEnum>
    {
		protected IStateProvinceTypeService Service {get { return this.DependencyResolver.Resolve<IStateProvinceTypeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IStateProvinceTypeService>() as TSupports;
        }		
