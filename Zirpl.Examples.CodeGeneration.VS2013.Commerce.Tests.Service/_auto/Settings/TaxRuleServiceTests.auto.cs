...
{	
	[TestFixture]
    public partial class TaxRuleServiceTests : TaxRuleDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class TaxRuleDataServiceTestsBase : EntityLayerTestFixtureBase<TaxRule, int, TaxRuleEntityWrapper, TaxRuleTestsStrategy>
    {
		protected ITaxRuleService Service {get { return this.DependencyResolver.Resolve<ITaxRuleService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ITaxRuleService>() as TSupports;
        }		
