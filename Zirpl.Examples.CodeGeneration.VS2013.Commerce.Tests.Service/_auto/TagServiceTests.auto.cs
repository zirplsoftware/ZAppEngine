...
{	
	[TestFixture]
    public partial class TagServiceTests : TagDataServiceTestsBase
    {
	}
    ...
    {
		protected ITagService Service {get { return this.DependencyResolver.Resolve<ITagService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<ITagService>() as TSupports;
        }		
