...
{	
	[TestFixture]
    public partial class EmailEventServiceTests : EmailEventDataServiceTestsBase
    {
	}
    ...
    {
		protected IEmailEventService Service {get { return this.DependencyResolver.Resolve<IEmailEventService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IEmailEventService>() as TSupports;
        }		
