...
namespace Zirpl.Examples.CodeGeneration.VS2013.Commerce.Tests.Service.Notifications
{
	[TestFixture]
    public partial class EmailEventTypeServiceTests : EmailEventTypeDataServiceTestsBase
    {
	}

    [TestFixture]
    public abstract partial class EmailEventTypeDataServiceTestsBase : DictionaryEntityLayerTestFixtureBase<EmailEventType, byte, EmailEventTypeEnum>
    {
		protected IEmailEventTypeService Service {get { return this.DependencyResolver.Resolve<IEmailEventTypeService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IEmailEventTypeService>() as TSupports;
        }		
