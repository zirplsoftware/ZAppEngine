...
{	
	[TestFixture]
    public partial class AddressServiceTests : AddressDataServiceTestsBase
    {
	}
    ...
    {
		protected IAddressService Service {get { return this.DependencyResolver.Resolve<IAddressService>(); } }
        ...
        {
            return this.DependencyResolver.Resolve<IAddressService>() as TSupports;
        }		
