...
{
    public partial class DisplayProductMetadata : MetadataBase
    {
		...
		public const int Description_MaxLength = MetadataBase.MaxLength;
		...
		public const int AdminComment_MaxLength = MetadataBase.MaxLength;
